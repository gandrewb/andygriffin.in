...
<!--
			<a href="https://itunes.apple.com/profile/andygriffin" class="icon-itunes"></a>
			<a href="" class="icon-etsy">Etsy</a>
			<a href="" class="icon-redbubble">Red Bubble</a>
-->
		</div>
		
		<figure class="logo"><img src="/imgs/ag_logo.svg"></figure>
	</header>